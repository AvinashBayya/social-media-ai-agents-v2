...
/**
 * U+00A0. Named rather than written literally: a bare non-breaking space in a
 * regex is indistinguishable from an ordinary space in every editor and diff,
 * so the substitution below could not be reviewed by eye and an accidental
 * keystroke could destroy it without leaving a trace.
 */
